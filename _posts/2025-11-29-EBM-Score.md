...
Energy-based models represent the pdf with an energy function, $$E_\phi(x)$$. Basically, the ideally learned EMB will tell us that higher probability data have lower energy.
